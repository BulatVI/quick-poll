package com.example.quick_poll.v1.controller;
...
public class PollController {
    ...
    public ResponseEntity<Iterable<Poll>> getAllPolls() {
        Iterable<Poll> allPols = pollRepository.findAll();
    ...
    public ResponseEntity<Poll> createPoll(@Valid @RequestBody Poll poll) {
        ...
        HttpHeaders responceHeaders = new org.springframework.http.HttpHeaders();
